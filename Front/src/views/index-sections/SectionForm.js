                    ...
                    <Card className='mx-auto shadow-sm mb-3 border mt-4' style={{ minWidth: '800px', maxWidth: '800px', minHeight: "500px" }}>
                        ...
                        <CardBody style={{ backgroundColor: "#373737" }}>
                            ...
                            <Row>
                                ...
                                <Col md="6">
                                    <label style={{ color: "white" }} htmlFor="">{this.props.label1}</label>
                                    <input type="text" className="form-control mb-4"
                                        name={this.props.nam}
                            ...
                            <Row>
                                <Col md="6">
                                    <label style={{ color: "white" }} htmlFor="model">{this.props.label2}</label>
                                    <input type="" className="form-control mb-4"
                                        name="model"
                                        value={this.props.value6}
                                        onChange={this.props.onchange}
                                        placeholder={this.props.place2}
                                    />
                                </Col>
                                <Col md="6">
                                    <label style={{ color: "white" }} htmlFor="size">{this.props.label3}</label>
                                    <input type="text" className="form-control mb-4"
                                        name="size"
                                        value={this.props.value7}
                                        onChange={this.props.onchange}
                                        placeholder={this.props.place3}
                                    />
                                </Col>
                            </Row>
                            <Row>
                                <Col md="12">
                                    ...
                                    <input type="file" class="form-control" placeholder="Coloque a Imagem" onChange={this.onImageChange} value={this.props.value4} name="image" rows="3"></input>
                                </Col>
                            </Row>
                        </CardBody>
