...
export default class SectionFormKitchen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            image: null
                    ...
                    <Card className='mx-auto shadow-sm mb-3 border mt-4' style={{ minWidth: '800px', maxWidth: '800px', minHeight: "500px" }}>
                        ...
                        <CardBody style={{ backgroundColor: "#373737" }}>
                            ...
                            <Row>
                                ...
                                <Col md="4">
                                    <label style={{ color: "white" }} htmlFor="size">Volume</label>
                                    <input type="text" className="form-control mb-4"
                                        name="volume"
                                ...
                                <Col md="4">
                                    <label style={{ color: "white" }} htmlFor="size">Quantidade</label>
                                    <input type="text" className="form-control mb-4"
                                        name="amount"
                            ...
                            <Row>
                                <Col md="12">
                                    ...
                                    <input type="file" class="form-control" placeholder="Coloque a Imagem" onChange={this.onImageChange} value={this.props.value8} name="image"  rows="3"></input>
                                </Col>
                            </Row>
                        </CardBody>
