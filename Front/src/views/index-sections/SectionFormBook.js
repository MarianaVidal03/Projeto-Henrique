...
export default class SectionFormBook extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            image: null
                    ...
                    <Card className='mx-auto shadow-sm mb-3 border mt-4' style={{ minWidth: '800px', maxWidth: '800px', minHeight: "500px" }}>
                        ...
                        <CardBody style={{ backgroundColor: "#373737" }}>
                            ...
                            <Row>
                                ...
                                <Col md="6">
                                    <label style={{ color: "white" }} htmlFor="">ISBN</label>
                                    <input type="text" className="form-control mb-4"
                                        name="ISBN"
                            ...
                            <Row>
                                <Col md="6">
                                    <label style={{ color: "white" }} htmlFor="model">Tipo de Capa</label>
                                    <input type="" className="form-control mb-4"
                                        name="typeCover"
                                        value={this.props.value5}
                                        onChange={this.props.onchange}
                                        placeholder="Digite o tipo de capa"
                                    />
                                </Col>
                                <Col md="6">
                            ...
                            <Row>
                                <Col md="12">
                                    ...
                                    <input type="file" class="form-control" placeholder="Coloque a Imagem" onChange={this.onImageChange} value={this.props.value7} name="image" rows="3"></input>
                                </Col>
                            </Row>
                        </CardBody>
